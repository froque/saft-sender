...
curl --silent -O https://faturas.portaldasfinancas.gov.pt/factemipf_static/java/FACTEMICLI-2.8.4-60332-cmdClient.jar

mvn -B org.apache.maven.plugins:maven-install-plugin:2.4:install-file -Dfile=FACTEMICLI-2.8.4-60332-cmdClient.jar \
                         -DgroupId=pt.gov.portaldasfinancas \
                         -DartifactId=FACTEMICLI \
                         -Dversion=2.8.4-60332 \
                         -Dpackaging=jar \
                         -DcreateChecksum=true \
                         -DlocalRepositoryPath=lib
